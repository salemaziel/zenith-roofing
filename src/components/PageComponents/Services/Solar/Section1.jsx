        ...
        <Container>
          <SideBar
            ...
            body={
              <>
                <p>
                  If you are thinking about installing solar on your roof, it is
                  best to schedule a roof inspection before you make a decision
                  to proceed with a solar contractor. PV Solar Systems should
                  last about 25 years, so you want to ensure the roofing
                  underneath the solar panels will last the same amount of time.
                </p>
                <p>
                Most solar companies are not willing to come out to the job for two visits,<strong><em> although it is the best option for the homeowner</em></strong>. Solar companies’ main competitor is the company you pay your electricity bill to, and their main goal is to beat the electric companies prices. Two visits can increase their cost so typically they would just like to do one visit. Two visits is the best option for the homeowner because the solar legs/mounts need to be installed on the rafters of the home or property to be able to be supported properly.
                </p>
                <p>
                ...
                <p>
                  Some solar contractors will install panels on a roof that will
                  only last 10 years, meaning you would have to remove them to
                  replace the roof, then have the panels reinstalled. This can
                  cost the homeowner or property owner thousands to remove and
                  reinstall the system. Solar companies will charge the property
                  owner to provide this service.
                </p>
                <p>
                  Additionally, you want to make sure the mounting/racking
                  system that is installed has flashings.A flashing, also known as a roof jack, is a metal that prevents water intrusions by directing water away from the penetration. They are commonly manufactured with a collar to make a seam higher than the roof level.
                </p>
<p>
